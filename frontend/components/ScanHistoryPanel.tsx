...
// The card frame, collapse header, and loading/empty states now live in the
// merged WhatChangedCard; this renders just the health-score trend (>= 2 scans)
// and the per-scan table with expandable broken-link detail. It is only rendered
// when history has at least one entry, so it carries no empty state of its own.
                ...
                >
                  ...
                  <td
                    style={{
                      ...
                      fontSize: "12px",
                      color:
                        scan.broken_count > 0 ? "#e05c5c" : "var(--text-muted)",
